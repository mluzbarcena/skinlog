/* =============================================================================
   Icon.tsx — hand-drawn SVG icons (no dependencies). Inherit color via
   currentColor. Ported from the vanilla icons.js, plus "home" and "globe".
   ============================================================================= */
...
const PATHS: Record<string, string> = {
  ...
  globe: '<circle cx="12" cy="12" r="9"/><line x1="3" y1="12" x2="21" y2="12"/><path d="M12 3c2.5 2.4 3.8 5.6 3.8 9s-1.3 6.6-3.8 9c-2.5-2.4-3.8-5.6-3.8-9S9.5 5.4 12 3z"/>',
};

const FILLED: Record<string, boolean> = { droplet: true, dot: true, spark: true, moon: true };
