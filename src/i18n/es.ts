...
export const es = {
  ...
  settings: {
    ...
    routinesTitle: "Pasos de la rutina",
    data: "Datos",
    language: "Idioma",
    ...
    deleteProductConfirm: (name: string): string =>
      `¿Eliminar "${name}"? Se quitará también de todas las rutinas. Tu historial no se modifica.`,
    noProducts: "Añadí al menos un producto para armar las rutinas.",
    routinePhase: "Fase",
    routineAm: "Mañana (AM)",
    addStep: "Añadir paso",
    chooseProduct: "Elegí un producto",
    optionalStep: "opcional",
    moveUp: "Subir",
    moveDown: "Bajar",
    removeStep: "Quitar",
    emptyRoutine: "Sin pasos todavía.",
    saved: "Guardado",
