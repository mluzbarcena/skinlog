...
export const en: Dict = {
  ...
  settings: {
    ...
    deleteProductConfirm: (name: string): string =>
      `Delete "${name}"? It will also be removed from every routine. Your history is left untouched.`,
    noProducts: "Add at least one product to build the routines.",
    routinePhase: "Phase",
    routineAm: "Morning (AM)",
    addStep: "Add step",
